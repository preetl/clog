...
class OnboardingPageViewController: UIPageViewController {
    ...
    var pageImages: [UIImage] = [UIImage(named:"clogfunky")!, UIImage(named:"dailycheckin")!, UIImage(named:"analytics-icon")!, UIImage(named:"privsecure")!]
    var pageDescriptionText = ["clog. will run in the background to create awareness of your mood and mobile phone habits to help you improve your lifestyle", "help us, help you by completing the daily questionnaire at the end of everyday. we'll send you a notification to remind you", "simply go about your day as normal and check clog. when you want an update", "clog. will collect data through phone sensors and screen on/off activities. your camera and microphone will not be monitored"]
    var currentIndex = 0
